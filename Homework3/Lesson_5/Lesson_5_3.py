...
def everything_for_your_cat(cats_data):
    ...
    our_str = str()
    cats_data_dict = {}
    for element in cats_data:
        people = element[2] + ' ' + element[3]
        animal = element[0] + ', ' + str(element[1])
        if people in cats_data_dict:
            cats_data_dict[people] = cats_data_dict[people] + '; ' + animal
        else:
            cats_data_dict[people] = animal
    for people, animal in cats_data_dict.items():
        our_str = our_str + people + ': ' + animal + '\n'
    return our_str
